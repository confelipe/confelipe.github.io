document.addEventListener('DOMContentLoaded', () => {
  ...
  // ==========================================================================
  const filterBtns = document.querySelectorAll('.filter-tabs:not(#articleCategoryFilters) .filter-btn');
  ...
  // ==========================================================================
  // 5. GitHub Public Repositories (repositorios.html)
  ...
  // ==========================================================================
  // 6. Articles & Reader Modal (artigos.html & Home showcase)
  // ==========================================================================
  const articleCategoryFilters = document.getElementById('articleCategoryFilters');
  const articleCards = document.querySelectorAll('#articles .article-card, main .article-card');

  if (articleCategoryFilters) {
  ...
  const articleData = {
    siem: {
      ...
      meta: "Por Carlos Felipe · Fevereiro 2026 · 7 min de leitura · Frameworks: ISO 27001, PCI-DSS & MITRE ATT&CK",
      body: `
...
deploy:
  ...
  // Handle URL hash on load (e.g., artigos.html#siem)
  const currentHash = window.location.hash.replace('#', '');
  if (currentHash && articleData[currentHash]) {
    setTimeout(() => {
      openArticleModal(currentHash);
    }, 200);
  }
